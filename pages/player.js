  ...
  return (
    <div className="player md:flex">
      ...
      <div className="fixed bottom-0 w-screen">
        ...
        <div class="bg-gray-50 text-black dark:bg-gray-900 dark:text-white lg:rounded-b-xl py-1 sm:px-3 lg:px-1 xl:px-3 grid grid-cols-5 sm:grid-cols-7 lg:grid-cols-5 xl:grid-cols-7 items-center">
          <button type="button" class="hidden sm:block lg:hidden xl:block mx-auto" id='start'>
            <svg width="17" height="18">
              <path d="M0 0h2v18H0V0zM4 9l13-9v18L4 9z" fill="currentColor" />
            </svg>
          </button>
          <button type="button" class="hidden sm:block lg:hidden xl:block mx-auto" id="end">
            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" >
              <path d="M17 0H15V18H17V0Z" fill="currentColor" />
              <path d="M13 9L0 0V18L13 9Z" fill="currentColor" />
            </svg>
          </button>
          <button type="button" class="mx-auto" id='-30'>
          ...
          <button type="button" class="mx-auto" id='playpause' value={'play'}>
